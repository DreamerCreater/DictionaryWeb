...
findAllPos=()=>{
  wordService.getAllPos()
    ...
    .then((data)=>{
        this.setState
        ({
            pos:[{value:'',display:'Хэл зүйн ангилал'}]
            .concat(data.map(poss =>{
                return {value:poss,display:poss}
            }))
        })
    })
};
...
console.error("Error - " +error)
  ...
  <Form.Group as={Col} controlId="formGridisActive">
    <Form.Label>Үгийн хэлбэр</Form.Label>
    <Form.Control required as ="select"
    custom onChange = {this.nameChange}
    name="isActive" value={isActive}
    className={"bg-dark text-white"}>
    {this.state.isActives.map(isActive =>
      <option key = {isActive.value} value={isActive.value}>
        {isActive.display}
      </option>)}
    </Form.Control>
  </Form.Group>
  ...
  <Form.Group as={Col} controlId="formGridotUud">
    <Form.Label>Олон тооны ууд нөхцөл</Form.Label>
    <Form.Control 
     autoComplete="off"
     type="test" name="otUud"
     value={otUud}
    onChange={this.nameChange} 
    className={"bg-dark text-white"}
  ...
  <Form.Group as={Col} controlId="formGridotChuud">
    <Form.Label>Олон тооны чууд нөхцөл</Form.Label>
    <Form.Control  autoComplete="off"
    type="test" 
    name="otChuud"
    value={otChuud}
    onChange={this.nameChange} 
    className={"bg-dark text-white"}
    placeholder="олон тооны чууд авах эсэх" />
  </Form.Group>
  <Form.Group as={Col} controlId="formGridotChuul">
    <Form.Label>Олон тооны чуул нөхцөл</Form.Label>
    <Form.Control 
     autoComplete="off"
     type="test" name="otChuul"
     value={otChuul}
    onChange={this.nameChange} 
    className={"bg-dark text-white"}
    placeholder="олон тооны чуул авах эсэх" />
  </Form.Group>
  </Form.Row>
  <Form.Row>
  <Form.Group as={Col} controlId="formGridotS">
    <Form.Label>Олон тооны c нөхцөл</Form.Label>
    <Form.Control  autoComplete="off"
    type="test" 
    name="otS"
    value={otS}
    onChange={this.nameChange} 
    className={"bg-dark text-white"}
    placeholder="Олон тооны с авах эсэх" />
  </Form.Group>
  <Form.Group as={Col} controlId="formGridotD">
    <Form.Label>Олон тооны Д нөхцөл</Form.Label>
    <Form.Control 
     autoComplete="off"
     type="test" name="otD"
     value={otD}
    onChange={this.nameChange} 
    className={"bg-dark text-white"}
    placeholder="Олон тооны д авах эсэх" />
  </Form.Group>
  </Form.Row>
  <Form.Row>
  <Form.Group as={Col} controlId="formGridotNar">
    <Form.Label>Олон тооны нар</Form.Label>
    <Form.Control  autoComplete="off"
    type="test" 
    name="otNar"
    value={otNar}
    onChange={this.nameChange} 
    className={"bg-dark text-white"}
    placeholder="Олон тооны нар авах эсэх" />
  </Form.Group>
  ...
  <Form.Group as={Col} controlId="formGridmbUsage">
    ...
    onChange={this.nameChange} 
    className={"bg-dark text-white"}
    placeholder="Монгол бичгийн хэрэглээ" />
  </Form.Group>
  </Form.Row>
