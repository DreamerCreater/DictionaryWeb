...
export default class ItemFound extends Component{
    constructor(props){
        super(props);
        this.state = {
            word:[],
...
findAllWordsOtD(){
   ...
   .then((data)=>{
    ...
    <tr>
      ...
      <th>Pos</th> 
      <th>Үгийн үндэс</th> 
      <th>Монгол хэлний бүлэг</th> 
      <th>Эгшиг</th> 
      <th>Монгол хэлний хэлбэр</th> 
      <th>Монгол бичгийн бүлэг</th> 
      <th>Эр эм</th> 
      <th>Монгол бичгийн хэлбэр</th> 
      <th>Нэмсэн өдөр</th> 
      <th>Устгасан өдөр</th> 
      <th>Үйлдэл</th>
    </tr>
