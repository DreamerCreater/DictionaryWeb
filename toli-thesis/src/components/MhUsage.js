...
export default class MhUsage extends Component{
    constructor(props){
        super(props);
        this.state = {
            word:[],
    ...
    searchData = () =>{
        ...
        axios.get("http://localhost:8080/api/test/usage?keyword="+this.props.match.params.search)
    ...
    findWordByMhUg=(search)=>{
        axios.get("http://localhost:8080/api/test/usage?keyword="+search)
