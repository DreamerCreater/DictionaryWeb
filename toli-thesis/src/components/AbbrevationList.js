...
this.search.data();
  ...
  <Col sm={8}>
        ...
        <Card className={"border border-dark bg-dark text-white"}  style={{ width: '80rem' }}>
              ...
              <FontAwesomeIcon icon={faList}/> Товчилсон үгсийн жагсаалт
              </div>
    ...
    <tr><th>Монгол хэлний үг</th>
      ...
      <th>Төлөв</th>
      <th>Үндэс</th>
    <th>Монгол хэлний аймаг</th>
    <th>Монгол хэлний хэрэглээ</th>
    <th>Үгийн хүйс</th>
    <th>Сүүлийн монгол хэлний үг</th>
    <th>Нэмсэн өдөр</th>
      <th>Үйлдэл</th>
    </tr>
  </thead>
...
<td>
    ...
    <Link to="/addabbr">  <FontAwesomeIcon icon={faPlusSquare} /> Үг нэмэх </Link>
        </Card>
        </Col>
